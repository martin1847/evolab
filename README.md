...
| **`templates/`** | 协作设定模板 `AGENTS.md.example`（人格 + 方法论）+ `rules/coding.md`（写码纪律真源，`paths:` 条件加载）。项目治理骨架（AGENTS.md / ADR / roadmap）由 `repo-governance-bootstrap` skill 生成，不在此重复。 |
...
> 再把 `templates/AGENTS.md.example` 的协作设定**并入（merge、非覆盖）**我的规则文件；
