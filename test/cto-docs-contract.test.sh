...
chk_contains "round runtime understanding gate starts" "Do not wait for approval or interaction" "$dexec_body"
chk_contains "duplex runtime understanding gate starts" "Do not wait for approval or interaction" "$agentctl_body"
