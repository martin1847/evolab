...
for t in emit.test.sh watch.test.sh scrape-fallback.test.sh ext-err-detection.test.sh dispatch-teardown.test.sh hook.test.sh cto-guard.test.sh retro-check.test.sh; do
  echo
  echo "==== $t ===="
