...
- **配比轴（8 分业务效果 : 2 分必要工程）**：开批前先判面——受益者是项目对外承诺服务的那类人 =
  业务面，受益者是我们自己（含自家席位 / 流程 / 工具）= 工程面，两者都真交付 = 混合面（判据与
  两件仪器的分工见 `meta/leverage-line.md` §第二轴）。**连续 2 批纯工程面 → 第 3 批开工前
  STOP-and-report**（业务面与混合面各自清零），向主理人冒泡「业务面下一步是什么」再定，不自驱
  续投；工程批各自健康（评审收敛 / 规模锚绿）不构成配比正当。比值本身不由此闸强制——它在复盘
  记账里呈现、由主理人判。
