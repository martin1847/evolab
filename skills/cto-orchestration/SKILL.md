...
- **配比轴（8 分业务效果 : 2 分必要工程）**：开批前先判面——受益者是项目对外承诺服务的那类人 =
  业务面，受益者是我们自己（含自家席位 / 流程 / 工具）= 工程面，两者都真交付 = 混合面。
  两件仪器不等价：**比值是目标不是闸**——面的归类自声明、自动分类必误判，故只在复盘记账里
  呈现、由主理人判；**唯一自动闸 = 连续 2 批纯工程面 → 第 3 批开工前 STOP-and-report**
  （业务面与混合面各自清零），冒泡「业务面下一步是什么」再定，不自驱续投。它只治「长时间零
  对外价值」这一种最坏形态：比值长期偏离但从不连续时闸看不见，靠复盘那一栏被人看见。工程批
  各自健康（评审收敛 / 规模锚绿）不构成配比正当。
